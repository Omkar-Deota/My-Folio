...
export const EXPERIENCES = [
  ...
  },
  {
    ...
    description:
      "Worked with a dynamic frontend team using latest technologies such as ReactJs and MaterialUi for developing the features for IONAGE application. Have worked on user management and graphical representation of charging consumption on their platform.",
    technologies: [
      "React.js",
      "TypeScript",
      "Material UI",
